    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "BCyBV6WJpTZcPG0b0WMfr8vJM1B3", "123 Oak Street", "Houston", "michaelj@example.com", "Michael", "Johnson", "TX", "77001" },
                    { "LoBA4EB98KfPtTZ7t8hE2xlbURw1", "456 Pine Street", "Chicago", "emilyd@example.com", "Emily", "Davis", "IL", "60601" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Reliable and fuel-efficient sedan.", "camry.jpg", true, "Toyota Camry", 25000.99m, 5, 1 },
                    { 2, 1, "Spacious and comfortable sedan.", "accord.jpg", true, "Honda Accord", 27000.99m, 4, 1 },
                    { 3, 2, "Spacious SUV for family trips.", "explorer.jpg", true, "Ford Explorer", 35000.99m, 3, 2 },
                    { 4, 2, "Full-size SUV with premium features.", "tahoe.jpg", true, "Chevrolet Tahoe", 48000.99m, 2, 2 },
                    { 5, 3, "Powerful truck for all your needs.", "f150.jpg", true, "Ford F-150", 42000.99m, 6, 1 },
                    { 6, 3, "Durable truck with a smooth ride.", "ram1500.jpg", true, "Ram 1500", 45000.99m, 3, 2 }
                });
